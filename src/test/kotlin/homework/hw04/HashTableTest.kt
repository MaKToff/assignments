...
internal class HashTableTest {
    ...
    @Test fun insertTest02() {
        val table = HashTable(10).insert(5).insert(2).insert(1).insert(3).insert(10)
                .insert(9).insert(100)
    ...
    @Test fun unionTest01() {
        val table = HashTable(10).insert(5).insert(2).insert(1).insert(3)
                .insert(9).insert(100).insert(1001)
    ...
    @Test fun intersectionTest01() {
        val table    = HashTable(10).insert(5).insert(2).insert(1).insert(3).insert(9)
        val newTable = HashTable(10)
    ...
    @Test fun intersectionTest03() {
        val table    = HashTable(10).insert(3).insert(17).insert(1)
