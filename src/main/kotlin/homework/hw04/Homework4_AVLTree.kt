...
open public class AVLTree() : Set() {
    ...
    public class Empty() : AVLTree() {}
    public class Leaf(val value : Int) : AVLTree() {}
    public class Node(val value : Int, val left : AVLTree, val right : AVLTree) : AVLTree() {
            ...
            is Node  -> {
                if (this.value == elem) {
                    if (this.left.getHeight() < this.right.getHeight()) {
                        ...
                        val temp   = this.left.fold({a, b -> Math.max(a, b)}, this.left.getTreeValue())
